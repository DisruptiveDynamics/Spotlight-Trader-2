...
module.exports = {
  ...
  overrides: [
    // JSON / JSONC
    { files: ["**/*.json","**/*.jsonc"], parser: "eslint-jsonc", extends: ["plugin:jsonc/recommended-with-json"] },
    ...
    { files: ["**/public/worklets/**/*.js"], globals: { AudioWorkletProcessor: "readonly", registerProcessor: "readonly" } },
  ],
  ignorePatterns: [
