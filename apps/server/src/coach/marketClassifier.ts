const MARKET_TERMS = [
  ...
  'entry', 'stop', 'target', 'risk reward', 'rr', 'r/r', 'chart', 'bars', 'candles',
  'ema', 'sma', 'moving average', 'volatility', 'regime', 'bullish', 'bearish',
  'bid', 'ask', 'spread', 'session', 'premarket', 'afterhours', 'trading at'
];
