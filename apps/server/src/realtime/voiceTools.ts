...
export const VOICE_COPILOT_TOOLS: VoiceTool[] = [
  {
    ...
    description: 'Get current chart data including OHLCV bars, indicators, session stats, volatility, and market regime for analysis',
    parameters: {
      type: 'object',
      properties: {
        symbol: {
  ...
  },
  {
    ...
    description: 'Calculate entry/exit proposal with R-multiples, risk/reward analysis, and rules validation',
    parameters: {
      type: 'object',
      properties: {
        symbol: {
  ...
  },
  {
    ...
    description: 'Get historical performance stats for a trading pattern including win rate, EV-R, MAE/MFE, false break rates',
    parameters: {
      type: 'object',
      properties: {
        symbol: {
  ...
  },
  {
    type: 'function',
    name: 'evaluate_rules',
    description: 'Check if a trade passes all risk management rules (position limits, daily loss, circuit breakers)',
    parameters: {
      type: 'object',
      properties: {
        symbol: {
  ...
  },
  {
    ...
    description: 'Generate a complete trade plan with entry zones, stop placement, targets, and risk management',
    parameters: {
      type: 'object',
      properties: {
        symbol: {
