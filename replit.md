...
Built with **React 18 and TypeScript**, using **Lightweight Charts** for financial charting and **Tailwind CSS** for styling. **Vite** handles bundling, and the SSE client manages automatic reconnection and backfill.
